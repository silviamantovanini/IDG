...
script="${GXSCRIPT}/postimage_cut_${obsnum}.sh"
cat "${GXBASE}/templates/postimage_cut.tmpl" | sed -e "s:OBSNUM:${obsnum}:g" \
                                 -e "s:BASEDIR:${base}:g" \
                                 -e "s:PIPEUSER:${pipeuser}:g" > "${script}"

output="${GXLOG}/postimage_cut_${obsnum}.o%A"
error="${GXLOG}/postimage_cut_${obsnum}.e%A"
