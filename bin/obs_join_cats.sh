...
usage()
{
echo "obs_join_cats.sh [-p project] [-d dep] [-t] [-m mosaicdir] [-c comb_freq] -n mosaic_name
...
sub="sbatch  --begin=now+1minutes --export=ALL  --time=00:30:00 --mem=${GXABSMEMORY}G -M ${GXCOMPUTER} --output=${output} --error=${error}"
