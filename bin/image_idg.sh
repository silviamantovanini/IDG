...
script="${GXSCRIPT}/image_IDG_${obsnum}.sh"
cat "${GXBASE}/templates/image_idg.tmpl" | sed -e "s:OBSNUM:${obsnum}:g" \
                                 -e "s:BASEDIR:${base}:g" \
                                 -e "s:DEBUG:${debug}:g" \
                                 -e "s:PIPEUSER:${pipeuser}:g" > "${script}"

output="${GXLOG}/image_IDG_${obsnum}.o%A"
error="${GXLOG}/image_IDG_${obsnum}.e%A"
