...
if __name__ == "__main__":
    ...
    for pol in POLS:
        out = f"{out_prefix}{pol}-{opts.subchan}{out_suffix}" #"%s%s%s%s" % (out_prefix, pol, subchan, out_suffix)
    ...
    for pol in POLS:
        ...
        hdus.writeto(f"{out_prefix}{pol}-{opts.subchan}{out_suffix}")
