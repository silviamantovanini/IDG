...
def main():
    ...
    if args.dst:
        dst_data = UVData()
        dst_data.read(args.dst, file_type='ms')
    ...
    #Applying flagging
    uvutils.apply_uvflag(dst_data, src_data)
    dst_data.write_ms(args.dst, clobber=True)
